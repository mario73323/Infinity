...
<body>
    <header class="site-header">
        <div class="contenedor">
            <div class="barra">
                <a href="index.php">
                    <img src="assets/img/logo.jpg" alt="logo" title="Logo Infinity" aria-label="Boton para ir hacia adelante" height="72">
                </a>
            ...
            <div class="anuncio">
                <div class="imagen-producto">
                    <?php
                        ...
                        if(file_exists($foto)){
                    ?>
                        <img src="<?php print $foto ?>" alt="<?php print $item['producto_descripcion']?> <?php print $item['producto_marca'] ?>" 
                        title="<?php print $item['producto_descripcion']?> <?php print $item['producto_marca'] ?>">
                    <?php }else {?>
                        <img src="" alt="">
                    <?php }?>
                </div>
