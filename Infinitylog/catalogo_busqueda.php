<?php 
    ...
    if($_SERVER['REQUEST_METHOD']==='POST'){
        ...
        {
            $info_producto = $producto->mostrar_por_categoria($_POST['categoria_id']);
        }
        if($_POST['categoria_id']==-1)
        ...
        <div class="contenedor">
            <div class="barra">
                ...
                <nav class="navegacion">
                    ...
                    <a href="contacto.html"><i class="fas fa-door-open"></i>Salir</a>
                </nav>
            </div>
        </div>
    </header>
    
    <section class="seccion contenedor wrapper">
            ...
            <label>Categoria</label>
                <select name="categoria_id" required>
                    ...
                    <?php
                        ...
                        <?php if($_POST['categoria_id']==$item['categoria_id']) print(" selected "); ?>><?php print $item['categoria_descripcion'] ?></option>
                            <?php }}?>
                </select>
